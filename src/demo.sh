...
python main.py --model EDSR --scale 4 --save edsr_baseline_x4_verse --reset --pre_train "C:\.py_workspace\EDSR\experiment\edsr_baseline_x4\model\model_best.pt" --n_colors 1 --data_train "VERSE"
